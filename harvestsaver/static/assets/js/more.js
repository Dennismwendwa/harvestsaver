document.addEventListener("DOMContentLoaded", function () {
    ...
    contactOwnerButton.addEventListener("click", function (event) {
    ...
    document.body.addEventListener("click", function (event) {
        if (!overlayContainer.contains(event.target) && overlayContainer.style.display === "flex") {
            overlayContainer.style.display = "none";
        }
    });
...
form.addEventListener("submit", function(event) {
  ...
  fetch("{% url 'payment:create-payment-intent' product.id %}", {
    method: "POST",
    headers: {
